...
user_activity = {1: "STANDING"}
user_location = {1: [0.0, 0.0]}

activity_data = {1: "data/activity1.txt"}
position_data = {1: "data/position1.txt"}
...
def refresher():
    ...
    text.configure(text=f' {user_activity[1]}', fg="red", font="Consolas 12 bold")
...
def refresher2():
    ...
    text1.configure(text=f'{user_location[1][0]}, {user_location[1][1]}', fg="blue", font="Consolas 10 bold")
...
# f0.place(x=170, y=20)
# text = tk.Label(f0, text='User 1', fg="black", font="Verdana 10 bold")
# text.pack()
...
f4 = tk.Frame(root, width=100, height=100, relief='solid', bd=0)
f4.place(x=130, y=10)
text = tk.Label(f4, text='ACTIVITY RECOGNITION', fg="black", font="Verdana 15 bold")
text.pack()

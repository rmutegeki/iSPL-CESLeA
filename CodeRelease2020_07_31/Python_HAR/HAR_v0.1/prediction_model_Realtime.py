...
n_sensors = 1
n_signals = 12               # Number of sensor signal used in 1 sensor (Ex: Acc_xyz, Gyr_xyz, Mag_xyz, linearAcc_xyz)
...
data_dim = 4        # the dimension of input data for the HAR model
# for 4-D input data
n_frames = 4
...
if data_dim == 3:
    ...
    targetModel_shape = (1, n_frames, -1, n_signals)    # divide the win_size into n_frames
...
# List of activities
# ACTIVITIES = ["IDLE", "WALKING", "STANDING", "SITTING", "LYING", "RUNNING", "CYCLING", "HAND-FREE"]
ACTIVITIES = [
    "WALKING",
    "STANDING",
    "SITTING",
...
checkpoint = f"pretrained_models/Thu_3act/ckp_{MODEL_NAME}"
